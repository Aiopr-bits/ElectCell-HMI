...
namespace SimulationDesignPlatform.UserControls
{
    public partial class UserControl1 : UserControl
    {
		...
		private void ShowSubChart(DataTable table, Chart chart, string title, bool[] checkList)
		{
			// 读取历史数据选择状态
			chart.Series.Clear();
		...
		private void ShowChart()
		{
			...
			ShowSubChart(Data.ResultDataTable, chart1, "电解电流", Data.data7_check);
			ShowSubChart(Data.ResultDataTable, chart5, "温度", Data.data8_check);
			ShowSubChart(Data.ResultDataTable, chart3, "氧中氢", Data.data9_check);
			ShowSubChart(Data.ResultDataTable, chart4, "氢中氧", Data.data10_check);
		}
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    Data.imagePath = openFileDialog.FileName;
                    PictureBox pictureBox1 = new PictureBox();
                    pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
                    pictureBox1.Dock = DockStyle.Fill;
                    pictureBox1.LoadAsync(selectedFileName);
                    panel1.Controls.Add(pictureBox1);
                    label7.Visible = false;
                    button5.Visible = false;
