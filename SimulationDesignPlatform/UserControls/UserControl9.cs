...
namespace SimulationDesignPlatform.UserControls
{
    public partial class UserControl9 : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                int node_id = int.Parse(node_text.Substring(node_text.Length - 1, 1));
                save_NodeData(node_id, 1);
            }
            else
            {
                save_NodeData2(node_text, 1);
            }
        ...
        private void save_NodeData(int id, int type)
        {
            if (type == 1)
            {
                for (int i = 0; i < Data.ele[id - 1].i_flow; i++)
        ...
        private void save_NodeData2(string str, int type)
        {
            if (str == "Cathode_separator")
            {
                if (type == 1)
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                int node_id = int.Parse(node_text.Substring(node_text.Length - 1, 1));
                save_NodeData(node_id, 2);
            }
            else
            {
                save_NodeData2(node_text, 2);
            }
